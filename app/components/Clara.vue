<template>
  <Page class="page">
    ...
    <StackLayout dock="top" height="90%" width="100%" style="">
      ...
      <Label text="Clara Munro" color="#000" fontSize="24" fontWeight="bold" textAlignment="center" />
...
export default {
  ...
  methods: {
      openGithub() {
        openUrl("https://github.com/claramunro");
      },
      openLinkedin() {
        openUrl("https://www.linkedin.com/in/claramunro/");
      },
      messageModal() {
