<template>
  <Page class="page">
    ...
    <StackLayout dock="top" height="90%" width="100%" style="">
      ...
      <Label text="Young Liu" color="#000" fontSize="24" fontWeight="bold" textAlignment="center" />
...
export default {
  ...
  methods: {
      openGithub() {
        openUrl("https://github.com/youngzliu");
      },
      openLinkedin() {
        openUrl("https://www.linkedin.com/in/young-liu-526832183/");
      },
      messageModal() {
